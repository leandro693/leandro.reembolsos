...
- **Gestão** (admin/financeiro): o **Dashboard** mostra o ranking **por pessoa**
  (lançamentos, a pagar, pago e total), além dos indicadores e gráficos gerais. O
  **Fechamento do mês** fica em **Ajustes**: baixa o lote inteiro de uma vez, com
  um comprovante de pagamento único e resumo por pessoa para o financeiro.
